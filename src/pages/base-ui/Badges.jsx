...
import { LuTrash2, LuHeart, LuKeyboard, LuMusic2, LuThumbsUp, LuMail, LuTrash, LuXCircle, LuLaugh, LuSmile } from "react-icons/lu";
...
const DefaultBadges = () => {
  return <ComponentContainerCard title="Default" description="Examples of badges containing Icons, using color variants. The badge is applied to its children." stackProps={{
    direction: "row",
    sx: {
      gap: 3
    }
...
const TextBadges = () => {
  return <ComponentContainerCard title="Text" description="Examples of badges containing text, using color variants." stackProps={{
    direction: "row",
    sx: {
      gap: 3
    }
...
const OutlinedChips = () => {
  return <ComponentContainerCard title="Outlined Chips" description="Outline variant Chips with colored text">
...
const FilledChips = () => {
  return <ComponentContainerCard title="Filled Chips" description="Filled variant Chips">
...
const AdornmentChips = () => {
  return <ComponentContainerCard title="Adornments Chips" description="You can add ornaments to the beginning of the component.">
      ...
      <Chip color="warning" variant="outlined" label="Avatar" avatar={<Avatar>
            <LuLaugh />
          </Avatar>} clickable />
      <Chip color="info" variant="outlined" label="Avatar" avatar={<Avatar>
            <LuSmile />
          </Avatar>} clickable />
      <Chip variant="outlined" label="Avatar & Delete" avatar={<Avatar src={avatar3} />} onDelete={() => {}} clickable />
    </ComponentContainerCard>;
};
const BadgeAlignment = () => {
  return <ComponentContainerCard title="Alignment" description="Examples of badges with different alignments" stackProps={{
    direction: "row",
    sx: {
      gap: 3
    }
      ...
      <Stack direction={"row"} spacing={3}>
        ...
        <Badge badgeContent={4} color="success" anchorOrigin={{
        vertical: "top",
        horizontal: "left"
      }}>
          <LuMusic2 size={24} />
...
const PositionedBadges = () => {
  return <ComponentContainerCard title="Positioned Badges" description="Use the anchorOrigin prop to change the position of the Badge according to its vertical (top or bottom) and horizontal (left or right) placement. " stackProps={{
    direction: "row",
    sx: {
      gap: 3
    }
...
const DeletableChips = () => {
  return <ComponentContainerCard title="Filled Chips" description="Chips are most frequently used in two main use cases: as pills of informative content or as filtering options.">
