import { Avatar, Box, Button, Divider, Fade, Grid, IconButton, List, ListItem, ListItemIcon, ListItemText, Menu, MenuItem, MenuList, Tooltip, Typography } from "@mui/material";
import { ComponentContainerCard, PageBreadcrumb } from "@src/components";
import { useDropdownMenu } from "@src/hooks";
import { useState } from "react";
import { styled, alpha } from "@mui/material/styles";
import { LuArchive, LuCheck, LuChevronDown, LuClipboard, LuCloud, LuCopy, LuLogOut, LuMoreHorizontal, LuMoreVertical, LuPencil, LuScissors, LuSettings, LuUserPlus } from "react-icons/lu";
const DefaultMenu = () => {
  const {
    anchorEl,
    open,
  ...
  return <ComponentContainerCard title="Default" description="Default styled Dropdown">
...
const IconMenu = () => {
  ...
  return <ComponentContainerCard title="Icon" description="Dropdown Menu with Icons">
...
const DenseMenu = () => {
  ...
  return <ComponentContainerCard title="Dense" description="Dense styled Dropdown with less padding">
...
const SelectedMenu = () => {
  ...
  const options = ["Show some love to Coderthemes", "Show all notification content", "Hide sensitive notification content", "Hide all notification content"];
  return <ComponentContainerCard title="Selected Options" description="If used for item selection, when opened, simple menus places the initial focus on the selected menu item. ">
...
const PositionedMenu = () => {
  ...
  return <ComponentContainerCard title="Positioned" description="Because the Menu component uses the Popover component to position itself">
...
const AccountMenu = () => {
  ...
  return <ComponentContainerCard title="Account" description="Dropdown Menu with Icons">
      <Box sx={{
      display: "flex",
      alignItems: "center",
      textAlign: "center"
...
const CustomDesignedMenu = () => {
  ...
  return <ComponentContainerCard title="Custom Designed Menu" description="Here is an example of customizing the component.">
      <Button id="demo-customized-button" aria-controls={open ? "demo-customized-menu" : undefined} aria-haspopup="true" aria-expanded={open ? "true" : undefined} variant="contained" disableElevation onClick={handleClick} endIcon={<LuChevronDown />}>
        Options
      </Button>
...
const MaxHeightMenu = () => {
  ...
  return <ComponentContainerCard title="Max Height" description="You can set the maximum height of the menu.">
...
const FadeTransitionMenu = () => {
  ...
  return <ComponentContainerCard title="Fade Transition" description="Fade Transition Menu Dropdown">
...
const ColorVariants = () => {
  ...
  return <ComponentContainerCard title="Color Variants" description="Toggler Color Variants for Dropdown menu">
...
const AlignmentMenu = () => {
  ...
  const handleMenuAlignment = position => {
    setPosition({
      horizontal: position.horizontal,
      vertical: position.vertical
    });
  };
  return <ComponentContainerCard title="Positioned" description="You can position the menu with anchorPosition props">
      <Button onClick={e => {
      handleClick(e);
      handleMenuAlignment({
        horizontal: "center",
...
const ContextMenu = () => {
  ...
  return <ComponentContainerCard title="Context" description="Right Click anywhere on the text to trigger Context Menu">
