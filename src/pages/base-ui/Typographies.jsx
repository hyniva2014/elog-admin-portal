...
const TypographyVariants = () => {
  return <ComponentContainerCard title="Component" description="The Typography component makes it easy to apply a default set of font weights and sizes in your application." stackProps={{
    direction: "column"
  }}>
...
const ColoredTypography = () => {
  return <ComponentContainerCard title="Colored" description="Colored Typography">
...
const ColoredOpacityTypography = () => {
  return <ComponentContainerCard title="Colored" description="Colored Opacity">
...
const TextDecoratedTypography = () => {
  return <ComponentContainerCard title="Text Decorated" description="Text Decorated Typography">
