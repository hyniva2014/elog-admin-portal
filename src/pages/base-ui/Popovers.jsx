import { Box, Button, FormControl, FormControlLabel, FormLabel, Grid, Input, InputLabel, Paper, Popover, Radio, RadioGroup, Typography } from "@mui/material";
...
const BasicPopover = () => {
  ...
  return <ComponentContainerCard title="Basic" description="A Popover can be used to display some content on top of another." stackProps={{
...
const AnchorPlaygroundPopover = () => {
  ...
  return <ComponentContainerCard title="Anchor" description="Use the radio buttons to adjust the anchorOrigin and transformOrigin positions">
      <Grid container justifyContent="center">
        ...
        mb: 4
          ...
          {anchorReference === "anchorEl" && <Box sx={{
          bgcolor: green[500],
          width: 10,
          height: 10,
          borderRadius: "50%",
      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={12} sm={6}>
          <FormControl component="fieldset">
            ...
            <RadioGroup aria-label="anchor origin vertical" name="anchorOriginVertical" value={anchorOriginVertical} onChange={handleChange}>
        ...
        <Grid item xs={12} sm={6}>
          <FormControl component="fieldset">
            ...
            <RadioGroup aria-label="transform origin vertical" name="transformOriginVertical" value={transformOriginVertical} onChange={handleChange}>
        ...
        <Grid item xs={12} sm={6}>
          <FormControl component="fieldset">
            ...
            <RadioGroup row aria-label="anchor origin horizontal" name="anchorOriginHorizontal" value={anchorOriginHorizontal} onChange={handleChange}>
        ...
        <Grid item xs={12} sm={6}>
          <FormControl component="fieldset">
            ...
            <RadioGroup row aria-label="transform origin horizontal" name="transformOriginHorizontal" value={transformOriginHorizontal} onChange={handleChange}>
...
const HoverPopover = () => {
  ...
  return <ComponentContainerCard title="Hoverable" description="Trigger on Hover Popover" stackProps={{
    justifyContent: "center"
  }}>
...
const VertialElementPopover = () => {
  ...
  return <ComponentContainerCard title="Virtual element" description="The value of the anchorEl prop can be a reference to a fake DOM element. ">
