...
const CustomAccordionSummary = styled(props => <AccordionSummary expandIcon={<LuChevronRight style={{
  fontSize: "0.9rem"
}} />} {...props} />)(({
  theme
}) => ({
...
const DefaultAccordions = () => {
  return <ComponentContainerCard title="Default" description="Default Accordions with Basic styling">
      <Accordion>
...
const DisabledAccordions = () => {
  return <ComponentContainerCard title="Disabled" description="Disabled Accordions example">
      <Accordion>
...
const CustomIconAccordion = () => {
  return <ComponentContainerCard title="Custom Icon" description="Accordion Items with Custom Icons">
      <Accordion sx={{
      ".Mui-expanded": {
      ...
      ".Mui-expanded": {
        ...
        <AccordionSummary expandIcon={<LuNavigation2 style={{
        rotate: "180deg"
