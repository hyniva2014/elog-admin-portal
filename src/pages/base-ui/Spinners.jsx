...
const DefaultSpinner = () => {
  return <ComponentContainerCard title="Default Circular" description="Linear indeterminate spinner, impossible to tract actual progress" stackProps={{
...
const ColoredSpinner = () => {
  return <ComponentContainerCard title="Colored Circular" description="Circular indeterminate spinner, impossible to tract actual progress" stackProps={{
    justifyContent: "center",
    display: "flex"
  }}>
...
const CircularDeterminateSpinner = () => {
  ...
  return <ComponentContainerCard title="Circular Determinate" description="Determinate progress spinner, whose actuall progress can be determined" stackProps={{
    justifyContent: "center",
    display: "flex"
  }}>
...
const CircularWithLabelSpinner = () => {
  ...
  return <ComponentContainerCard title="Circular With Label" description="Determinate progress spinner, whose actuall progress can be determined" stackProps={{
    justifyContent: "center",
    display: "flex"
  }}>
      <Box sx={{
...
const DelayedAppearanceSpinner = () => {
  ...
  return <ComponentContainerCard title="Delayed Appearance" description="Determinate progress spinner, whose actuall progress can be determined" stackProps={{
    justifyContent: "center",
    display: "flex"
  }}>
      <Box sx={{
...
const InteractiveIntegration = () => {
  ...
  return <ComponentContainerCard title="Interactive Integration" description="Interactive spinner with progress value" stackProps={{
    justifyContent: "center",
    display: "flex"
  }}>
      <Box sx={{
