...
const Card1 = () => {
  return <Card>
      <CardMedia sx={{
      height: 248
    }} image={small1} title="Kitchen Drink" />
      <CardContent>
...
const Card2 = () => {
  return <Card>
      <CardMedia sx={{
      height: 243
    }} image={small2} title="Kitchen Drink" />
      <CardContent>
        <Typography gutterBottom variant="h5">
          Promotion Party 🎉
        </Typography>
...
const Card3 = () => {
  return <Card>
      <CardMedia sx={{
      height: 248
    }} image={small3} title="Kitchen Drink" />
      <CardContent>
        <Typography variant="body2" color="text.secondary">
          Some quick example text to build on the card title and make up the bulk of the card's content. Some quick
        </Typography>
...
const Card4 = () => {
  return <Card>
      ...
      <CardMedia sx={{
      height: 258
    }} image={small4} title="Kitchen Drink" />
    </Card>;
};
const Card5 = ({
  color
...
const Card9 = () => {
  return <Card>
      <CardMedia sx={{
      height: 140
    }} image={small5} title="green iguana" />
      <CardContent>
...
const UIControlsCard = () => {
  return <Card sx={{
    ...
    justifyContent: "space-between"
      ...
      width: 151
    }} image={small6} alt="Live from space album cover" />
    </Card>;
};
