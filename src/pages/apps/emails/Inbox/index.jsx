...
import { Box, Button, ButtonGroup, Card, CardContent, Drawer, Grid, Typography } from "@mui/material";
      ...
      <Grid container spacing={3}>
        <Grid item xl={2.5} lg={4} xs={12}>
          {width >= 1024 ? <LeftPanel totalUnreadEmails={totalUnreadEmails} showAllEmails={showAllEmails} showStarredEmails={showStarredEmails} /> : <Drawer open={isOpen} onClose={hide}>
              <LeftPanel showInDrawer={isOpen} totalUnreadEmails={totalUnreadEmails} showAllEmails={showAllEmails} showStarredEmails={showStarredEmails} />
            </Drawer>}
        </Grid>
