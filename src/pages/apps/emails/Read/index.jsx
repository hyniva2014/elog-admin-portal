import { Avatar, Box, Button, Card, CardContent, Divider, Drawer, Grid, IconButton, Stack, Typography } from "@mui/material";
  ...
  return <>
      ...
      <Grid container spacing={3}>
        <Grid item xl={2.5} lg={4} xs={12}>
          {width >= 1024 ? <LeftPanel totalUnreadEmails={totalUnreadEmails} showAllEmails={showAllEmails} showStarredEmails={showStarredEmails} /> : <Drawer open={isOpen} onClose={hide}>
              <LeftPanel totalUnreadEmails={totalUnreadEmails} showAllEmails={showAllEmails} showStarredEmails={showStarredEmails} />
            </Drawer>}
        </Grid>
          ...
          <Card>
            <CardContent>
              ...
              mt: "16px"
                ...
                }} variant="circular" src={attachments.avatar} alt={attachments.from_name} />
                  <Stack sx={{
                  width: "100%"
                }}>
                ...
                <Typography variant="h5" color={"grey.700"} sx={{
                mb: "12px"
              }}>
                  Attachments
                </Typography>
                    ...
                    borderStyle: "solid"
                      ...
                      pb: "16px !important"
                        ...
                        display: "flex"
                            ...
                            {item.preview ? <Avatar src={item.preview} variant="rounded" alt="file-image" sx={{
                          mr: 1,
                          width: 40,
                          height: 40
                        }} /> : <Typography sx={{
