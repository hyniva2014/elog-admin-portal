...
const LeftPanel = ({
  ...
  return <Card sx={{
    minWidth: showInDrawer ? "320px" : "unset",
    height: "100%",
    minHeight: "100%"
  }}>
      <SimpleBar style={{
      ...
      padding: 24
        ...
        mt: "24px"
          ...
          <Typography onClick={showAllEmails} sx={{
          my: "12px",
          px: "6px",
          display: "flex",
          alignItems: "center",
          ...
          <Typography onClick={showStarredEmails} sx={{
          my: "12px",
          px: "6px",
          display: "flex",
          alignItems: "center"
        ...
        mt: 8
          ...
          <LinearProgress color="success" variant="determinate" value={46} sx={{
          mt: 2
        }} />
