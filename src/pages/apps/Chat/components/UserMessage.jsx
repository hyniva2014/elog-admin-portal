...
import { Avatar, Box, IconButton, ListItemIcon, ListItemText, Menu, MenuItem, MenuList, Typography } from "@mui/material";
  ...
  return <Box sx={{
    ...
    "& .chat-bubble-options": {
      ...
      textAlign: "center"
        ...
        <Avatar src={message.from.avatar} sx={{
        height: "32px",
        width: "32px"
      }} />
      ...
      {message.message.type === "text" && <Box sx={{
      maxWidth: "75%",
      p: "12px",
      position: "relative",
      borderRadius: "4px",
      ...
      {message.message.type === "file" && <Box sx={{
      my: 1.5,
      borderWidth: "1px",
      borderRadius: "4px",
      p: "12px",
