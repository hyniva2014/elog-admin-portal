import { Avatar, Box, Grid, IconButton, ListItemIcon, Menu, MenuItem, Table, TableBody, TableCell, TableHead, TableRow, Tooltip, Typography } from "@mui/material";
                    ...
                    return <TableRow key={idx}>
                        ...
                        p: "14px"
                          ...
                          display: "flex"
                            ...
                            return <Tooltip key={idx} title={member.name} placement="top" arrow>
                                    <Box sx={{
                                height: "32px",
                                width: "32px",
                                ml: "-5px",
                                "&:hover": {
                                  ...
                                  transition: "300ms"
                                      ...
                                      <Avatar src={member.image} variant="circular" sx={{
                                  display: "inline-block",
                                  height: "100%",
                                  width: "100%"
                                }} />
                        ...
                        p: "14px"
                            ...
                            <IconButton sx={{
                          px: "6px"
                        }} onClick={handleClick} aria-controls={open ? "account-menu" : undefined} aria-haspopup="true" aria-expanded={open ? "true" : undefined}>
