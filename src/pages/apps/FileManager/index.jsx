import { Box, Card, CardContent, Drawer, IconButton, InputAdornment, TextField } from "@mui/material";
      ...
      gap: "16px"
        ...
        position: {
          ...
          xs: "fixed"
            ...
            <LeftPanel />
          </Box> : <Drawer open={isOpen} onClose={hide}>
            <LeftPanel />
          </Drawer>}
        <Card sx={{
        p: "8px",
              ...
              gap: "16px"
                ...
                <form>
                  ...
                  borderRadius: "6px"
                    ...
                    <TextField id="input-with-icon-textfield" size="small" InputProps={{
