...
import { Avatar, Box, Button, Card, Checkbox, Divider, FormControlLabel, IconButton, TextField, Typography } from "@mui/material";
  ...
  return <Card sx={{
    ...
    borderRadius: {
      ...
      width: "auto"
        ...
        rowGap: "12px"
          ...
          width: {
            ...
            alignItems: "center"
              ...
              <Avatar variant="circular" src={task.assignee_avatar} alt={task.assigned_to} sx={{
              height: "24px",
              width: "24px",
              mr: "12px"
            }} />
        ...
        mt: "24px"
          ...
          width: "100%"
            ...
            borderRadius: "4px"
              ...
              <ReactQuill theme="bubble" value={editorValue} onChange={setEditorValue} style={{
              height: 130
            }} />
            </Box>
          </Box>
        ...
        {task.checklists.map((checklist, idx) => <Box key={idx} sx={{
        display: "flex",
        alignItems: "center",
        gap: "8px",
        m: "0px"
      }}>
            <Checkbox id={`checklist-${checklist.id}`} sx={{
          borderRadius: "4px",
          padding: "0px",
          mt: "6px"
        }} defaultChecked={checklist.completed} />
            <Typography component={"label"} htmlFor={`checklist-${checklist.id}`} sx={{
          color: "text.primary",
          fontSize: "13px",
          mt: "6px"
        }}>
        ...
        mt: "24px"
          ...
          width: "100%"
            ...
            {task.comments.map((comment, idx) => <Fragment key={idx}>
                <Box sx={{
              display: "flex",
              mt: "24px",
              p: "6px"
            }}>
                  <Avatar src={comment.author_avatar} variant="circular" sx={{
                height: "36px",
                width: "36px",
                mr: "12px"
              }} alt={comment.author} />
