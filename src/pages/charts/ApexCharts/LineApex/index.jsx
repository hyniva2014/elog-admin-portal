      ...
      <Grid container spacing={3}>
        ...
        <Grid item xl={6} xs={12}>
          <ComponentContainerCard title="Gradient Line Chart">
            <Box width={"100%"}>
              <ReactApexChart className="apex-charts" options={gradientLineChartOpts} height={430} series={gradientLineChartOpts.series} type="line" />
            </Box>
          </ComponentContainerCard>
        </Grid>
        <Grid item xl={6} xs={12}>
        ...
        <Grid item xl={6} xs={12}>
          <ComponentContainerCard title="Stepline Chart">
            <Box width={"100%"}>
              <ReactApexChart className="apex-charts" options={steplineChartOpts} height={390} series={steplineChartOpts.series} type="line" />
            </Box>
          </ComponentContainerCard>
        </Grid>
        <Grid item xl={6} xs={12}>
