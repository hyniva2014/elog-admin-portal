import messenger from "@src/assets/images/brands/messenger.png";
import instagram from "@src/assets/images/brands/instagram.png";
...
export const datetimeOpts = {
  ...
  colors: ["#6c757d", "#ffbc00", "#3e60d5", "#47ad77", "#fa5c7c"],
  grid: {
    borderColor: "#f1f3fa",
    padding: {
      bottom: 5
