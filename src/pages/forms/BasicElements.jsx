import { Box, FilledInput, FormControl, FormHelperText, Grid, IconButton, Input, InputAdornment, InputLabel, MenuItem, OutlinedInput, TextField, styled } from "@mui/material";
...
const BasicTextField = () => {
  return <ComponentContainerCard title="Basic TextField" description="The TextField wrapper component is a complete form control including a label, input, and help text.">
...
const FormPropsTextField = () => {
  return <ComponentContainerCard title="Form Props" description="Standard form attributes are supported e.g. required, disabled, type, etc." stackProps={{
    direction: "column"
  }}>
      <FieldInputsContainer>
...
const ValidationTextField = () => {
  return <ComponentContainerCard title="Validation" description="The error prop toggles the error state.">
      <FieldInputsContainer>
...
const MultilineTextField = () => {
  return <ComponentContainerCard title="Multiline" description="The multiline prop transforms the text field into a TextareaAutosize element. ">
      <FieldInputsContainer>
...
const SelectTextInput = () => {
  ...
  return <ComponentContainerCard title="Select" description="The select prop makes the text field use the Select component internally.">
      <FieldInputsContainer>
...
const TextInputWithIcon = () => {
  return <ComponentContainerCard title="Icons" description="There are multiple ways to display an icon with a text field.">
      <FieldInputsContainer>
...
const AdornmentTextInput = () => {
  ...
  return <ComponentContainerCard title="Adornment" description="This can be used to add a prefix, a suffix, or an action to an input.">
      <FullWidthInputsContainer>
        ...
        display: {
          ...
          width: "25ch"
            ...
            <OutlinedInput id="outlined-adornment-password" type={isOpen ? "text" : "password"} endAdornment={<InputAdornment position="end">
                  <IconButton aria-label="toggle password visibility" onClick={toggleOpen} onMouseDown={handleMouseDownPassword} edge="end">
      ...
      <FullWidthInputsContainer>
        ...
        display: {
          ...
          <TextField label="With normal TextField" id="filled-start-adornment" sx={{
          m: 1,
          width: "25ch"
        }} InputProps={{
          startAdornment: <InputAdornment position="start">kg</InputAdornment>
          ...
          width: "25ch"
            ...
            <FilledInput id="filled-adornment-password" type={isOpen ? "text" : "password"} endAdornment={<InputAdornment position="end">
                  <IconButton aria-label="toggle password visibility" onClick={toggleOpen} onMouseDown={handleMouseDownPassword} edge="end">
                    {isOpen ? <LuEyeOff /> : <LuEye />}
                  </IconButton>
                </InputAdornment>} />
      ...
      <FullWidthInputsContainer>
        ...
        display: {
          ...
          <TextField label="With normal TextField" id="standard-start-adornment" sx={{
          m: 1,
          width: "25ch"
        }} InputProps={{
          startAdornment: <InputAdornment position="start">kg</InputAdornment>
          ...
          width: "25ch"
            ...
            <Input id="standard-adornment-password" type={isOpen ? "text" : "password"} endAdornment={<InputAdornment position="end">
                  <IconButton aria-label="toggle password visibility" onClick={toggleOpen} onMouseDown={handleMouseDownPassword}>
                    {isOpen ? <LuEyeOff /> : <LuEye />}
                  </IconButton>
                </InputAdornment>} />
          </FormControl>
...
const SizesTextInput = () => {
  return <ComponentContainerCard title="Sizes" description="Fancy smaller inputs? Use the size prop.">
      <FieldInputsContainer>
...
const MarginTextInput = () => {
  ...
  return <ComponentContainerCard title="Margin" description="The margin prop can be used to alter the vertical spacing of the text field." stackProps={{
...
const FullWidthTextInput = () => {
  return <ComponentContainerCard title="Full Width" description="The fullWidth prop can be used to make the text field full width.">
      <TextField label="Full Width" id="full-width" defaultValue="Full Width" fullWidth />
    </ComponentContainerCard>;
};
const ColoredTextInput = () => {
  return <ComponentContainerCard title="Colored" description="The color prop can be used to use colored TextField">
      <FieldInputsContainer>
