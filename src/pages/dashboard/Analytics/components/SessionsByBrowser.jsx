import { Avatar, Box, Card, CardContent, List, ListItem, Typography } from "@mui/material";
...
const SessionsByBrowser = () => {
  ...
  return <Card>
      ...
      <CardContent>
        <Box pt={0}>
          <ReactApexCharts className="apex-charts" options={apexOpts} series={apexOpts.series} type="radar" height={345} />
