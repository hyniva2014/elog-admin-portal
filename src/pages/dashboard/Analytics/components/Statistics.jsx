          ...
          <Card>
            ...
            padding: "24px"
              ...
              <Box display={"flex"} alignItems={"center"} justifyContent={"space-between"}>
                <Box>
                  <Typography variant="h4" component={"h3"} color={"text.secondary"} sx={{
                  mb: 3,
                  fontSize: {
                    md: 20
                  }
                  ...
                  <Typography color={"success.main"} variant="body1" sx={{
                  display: "flex",
                  gap: 1,
                  alignItems: "center",
                  fontWeight: 600,
          ...
          <Card>
            ...
            padding: "24px"
              ...
              <Box display={"flex"} alignItems={"center"}>
                <Box width={"50%"}>
                  <Typography variant="body1" component={"h5"} sx={{
                  marginTop: 0,
                  fontWeight: 500,
                  color: "grey.700",
                ...
                <Box width={"50%"} textAlign={"end"}>
                  <ReactApexCharts className="apex-charts" options={userApexOpts} series={userApexOpts.series} type="bar" height={60} />
                </Box>
              </Box>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            padding: "24px"
              ...
              <Box display={"flex"} alignItems={"center"}>
                ...
                <Box width={"50%"} textAlign={"end"}>
                  <ReactApexCharts className="apex-charts" options={viewsApexOpts} series={viewsApexOpts.series} type="line" height={60} />
                </Box>
              </Box>
            </CardContent>
          </Card>
