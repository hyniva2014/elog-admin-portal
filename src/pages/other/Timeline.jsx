        ...
        return <Fragment key={idx}>
            ...
            textAlign: {
              md: "center"
                ...
                <Button variant="contained" disableRipple disableFocusRipple disableTouchRipple disableElevation color="secondary" sx={{
              "&:hover": {
                      ...
                      xs: "80px"
                        ...
                        backgroundColor: "grey.50"
                          ...
                          justifyContent: {
                            ...
                            return <Avatar key={idx} variant="rounded" src={img} sx={{
                              height: "36px",
                              width: "60px"
                            }} />;
                          })}
                                </Box>}
                              {item.reactions && <Box sx={{
                          display: "flex",
                          gap: 1,
                          justifyContent: {
                            xs: "start",
                            ...
                            return <Button variant="contained" key={idx} size="small" startIcon={item.emoji} color="secondary">
                                        {item.count}
                                      </Button>;
                          })}
                                </Box>}
                          ...
                          justifyContent: "end"
                            ...
                            return <Fragment key={idx}>
                                        <Avatar src={item.image} alt="Arya S" variant="circular" sx={{
                                mr: "12px",
                                height: "24px",
                                width: "24px"
                              }} />
