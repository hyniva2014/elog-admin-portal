import { AppBar, Avatar, Box, Button, Card, CardContent, Grid, IconButton, InputAdornment, InputLabel, OutlinedInput, Popover, Tab, Table, TableBody, TableCell, TableHead, TableRow, Tabs, TextField, Typography } from "@mui/material";
import { LuBook, LuBriefcase, LuBuilding, LuCamera, LuCircleDot, LuGithub, LuGlobe, LuHeart, LuLoader, LuMapPin, LuMonitor, LuMoreVertical, LuReply, LuSave, LuShare2, LuSticker, LuTwitter } from "react-icons/lu";
          ...
          <Grid item xs={12}>
            ...
            textAlign: "center"
              ...
              padding: "24px"
                ...
                <Avatar variant="circular" src={avatar1} sx={{
                width: "86px",
                height: "86px",
                marginX: "auto"
              }} />
                <Typography component={"h4"} marginBottom={"4px"} marginTop={"12px"} fontSize={"18px"} lineHeight={"28px"}>
                  Tosha Minner
                </Typography>
                ...
                <Box textAlign={"start"} marginTop={"24px"}>
                  <Typography component={"h4"} fontSize={"14px"} marginBottom={"10px"} color={"grey.700"} fontWeight={500} textTransform={"uppercase"} lineHeight={"20px"}>
                    About Me :
                  </Typography>
                  ...
                  <Typography display={"flex"} fontWeight={600} color={"grey.600"} component={"p"} marginBottom={"12px"}>
                    Full Name :
            ...
            marginTop: "24px"
              ...
              padding: "24px"
                ...
                <Box display={"flex"} justifyContent={"space-between"} alignItems={"center"} marginBottom={"12px"}>
                  <Typography component={"h4"} fontSize={"16px"} lineHeight={"24px"} marginBottom={"8px"} color={"grey.700"}>
                    Messages
                  </Typography>
                  <IconButton ref={anchorRef} onClick={handleClickButton}>
                    <LuMoreVertical size={16} />
                  </IconButton>
                  <Popover open={open} anchorEl={anchorRef.current} anchorReference={anchorReference} anchorPosition={{
                  top: 200,
                  left: 400
                }} anchorOrigin={{
                  vertical: "top",
                ...
                {(messages || []).map(item => <Box key={item.id} overflow={"hidden"} paddingTop={"10px"} position={"relative"}>
                    <Box sx={{
                  borderBottom: "1px solid",
                  borderColor: "divider"
                }} overflow={"hidden"} paddingY={"10px"} position={"relative"}>
                      <Box sx={{
                    width: "100%",
                    display: "flex"
                  }}>
                        <Avatar variant="circular" src={item.img} sx={{
                      marginRight: "14px"
                    }} />
                        <Box>
                ...
                <SwipeableViews index={value} onChangeIndex={handleChangeIndex}>
                  <CustomTabPanel value={value} index={0}>
                      ...
                      minWidth: "100%"
                        ...
                        overflow: "hidden"
                          ...
                          fontSize: "14px"
                            ...
                            <TableBody>
                              {projectTableData.map(item => <TableRow key={item.id}>
                                  <TableCell sx={{
                                padding: "8px"
                              }}>{item.id}</TableCell>
                                  <TableCell sx={{
                    ...
                    position: "relative"
                      ...
                      {experienceData.map(item => <Box key={item.id} sx={{
                      position: "relative"
                    }}>
                          <Box sx={{
                        position: "absolute",
                  ...
                  <CustomTabPanel value={value} index={1}>
                    ...
                    mb: "24px"
                      ...
                      borderRadius: "5px"
                        ...
                        <TextField id="outlined-multiline-static" multiline fullWidth rows={4} defaultValue="Write Something..." />
                        <Box sx={{
                        p: "8px",
                        bgcolor: "divider",
                        display: "flex",
                    ...
                    mb: "12px"
                        ...
                        <Box display={"flex"}>
                          ...
                          <Box>
                            ...
                            <Box display={"flex"} mt={"24px"}>
                              <Avatar variant="circular" src={avatar4} sx={{
                              mr: "12px",
                              height: "32px",
                              width: "32px"
                            }} />
                      ...
                      mt: "8px"
                        ...
                        mr: "4px"
                      }} startIcon={<LuHeart size={14} />} color="error">
                    ...
                    mb: "24px"
                      ...
                      <Box mt={"8px"} px={"10px"}>
                        <Button size="small" sx={{
                        mr: "4px"
                      }} startIcon={<LuReply size={14} />} color="secondary">
                          Reply
                        </Button>
                        <Button size="small" sx={{
                        mr: "4px"
                      }} startIcon={<LuHeart size={14} />} color="secondary">
                          
                          Like
                        </Button>
                        <Button size="small" sx={{
                        mr: "4px"
                      }} startIcon={<LuShare2 size={14} />} color="secondary">
                    ...
                    mb: "24px"
                      ...
                      <iframe src="https://player.vimeo.com/video/87993762" style={{
                      border: "1px solid"
                    }}></iframe>
                    </Box>
                  ...
                  <CustomTabPanel value={value} index={2}>
                    <Typography pt={"10px"} component={"h5"} sx={{
                    display: "flex",
                    alignItems: "center",
                    mb: "36px",
                    textTransform: "uppercase"
                  }}>
                      <LuBook size={20} style={{
                      marginRight: "6px"
                    }} />
                    ...
                    <Typography bgcolor={"grey.200"} component={"h5"} sx={{
                    p: "8px",
                    display: "flex",
                    alignItems: "center",
                    mb: "36px",
                    ...
                    <Grid container spacing={2} mb={"24px"}>
                      ...
                      }} variant="standard" placeholder="Url" size="small" />
                      </Grid>
                      <Grid item xs={12} lg={6} mb={"12px"}>
                        <InputLabel sx={{
                        pb: "5px"
                      ...
                      }} variant="standard" placeholder="username" size="small" />
                      </Grid>
                      <Grid item xs={12} lg={6} mb={"12px"}>
                        <InputLabel sx={{
                        pb: "5px"
                      }}>Instagram</InputLabel>
                        <TextField fullWidth InputProps={{
                        startAdornment: <InputAdornment position="start">
                                <FiInstagram size={20} />
                              </InputAdornment>
