...
const LucideIcons = () => {
  ...
  return <>
      ...
      <ComponentContainerCard title="All Icons" description="The below example shows how can lucide-react icons be used in your Admin">
        <Grid container spacing={3} mt={"10px"}>
          {allLucideIcons.map((icon, idx) => {
          return <Grid item lg={3} md={4} xs={12} key={idx}>
                <Box sx={{
              display: "flex",
              alignItems: "center",
              columnGap: "12px",
