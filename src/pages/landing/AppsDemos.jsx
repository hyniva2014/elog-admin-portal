  ...
  return <Box sx={{
    ...
    backgroundColor: "background.paper"
      ...
      <ContainerBox>
        ...
        <Grid container spacing={4} data-aos="fade-up" data-aos-duration={1000}>

          {appDemos.map(app => <Grid item lg={4} md={6} xs={12} key={app.link}>
              <DemoCard link={app.link} image={app.image} name={app.name} />
            </Grid>)}
