...
import { Grid, Box, IconButton, Button, CircularProgress, Snackbar, Alert, Tabs, Tab, Rating, Chip, Avatar, Switch, Radio, FormControlLabel, Checkbox, Fab, Stack, TextField, MenuItem, Typography } from "@mui/material";
import { LuSearch, LuTrash2, LuSendHorizonal, LuHeart, LuPhone, LuContact2, LuPlus, LuShoppingCart } from "react-icons/lu";
              ...
              borderRadius: 1
                ...
                flexWrap: 'wrap'
                  ...
                  <Snackbar open={isOpen} autoHideDuration={6000} onClose={hide}>
                    <MuiAlert onClose={hide} severity={'warning'} sx={{
                    width: "100%"
                  }}>
                ...
                alignItems: 'center'
                  ...
                  <Grid item md={4} xs={12}>
                    ...
                    gap: 2
                      ...
                      <TextField label="Temperature" defaultValue="Cool" select>
              ...
              paddingTop: '80px'
                ...
                position: 'relative'
                  ...
                  flexDirection: 'column'
                    ...
                    <Box>
                      <Button variant="contained" color="primary" startIcon={<LuShoppingCart size={20} />}>
                        Buy Now
                      </Button>
                    </Box>
