...
const ConfirmMail2 = () => {
  return <>
      ...
      <AuthLayout2 authTitle="Please check your email" helpText="A email has been send to youremail@domain.com. Please check for an email from company and click on the included link to reset your password." pageImage={mailImg} bottomLinks={<BottomLink />}>
        <Box sx={{
        display: "flex",
