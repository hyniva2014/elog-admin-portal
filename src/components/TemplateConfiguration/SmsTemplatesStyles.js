...
export const searchInputPropsStyle = { fontSize: 13, borderRadius: 1.5 };
...
export const createButtonStyle = { borderRadius: 1.5, fontSize: 13, fontWeight: 600 };
...
export const editorInputPropsStyle = { fontSize: 13, borderRadius: 1.5 };
...
export const editorFooterButtonStyle = { borderRadius: 1.5, fontSize: 13 };
