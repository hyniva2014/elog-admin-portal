...
export const getEditorContentStyle = (theme, isDark) => ({
  ...
  '& .ql-editor': { minHeight: 200, fontSize: 14, lineHeight: 1.65, color: theme.palette.text.primary },
});
...
export const templateNameInputPropsStyle = { fontSize: 14, borderRadius: 1.5 };
