...
// import { CsvIcon, ErrorText, ExcelIcon, FileInfoWrapper, FileNameText, FilePreviewContainer, UploadCloudIcon, UploadContainer, UploadHighlightText, UploadIconWrapper, UploadSubText, UploadText } from "./bulkUpload.styles";
...
//   const handleRemoveFile = (event, onChange) => {
//     event.preventDefault();
//     onChange(null);
//   };

//   const onRemoveFileClick = (onChange) => (event) => {
//     handleRemoveFile(event, onChange);
//   };
...
//                 <IconButton
//                   onClick={onRemoveFileClick(field.onChange)}
//                   size="small"
//                 >
//                   <CloseIcon />
//                 </IconButton>
